...
const SHELL = [
  ...
  './css/styles.css?v=67',
  './js/data.js?v=67','./js/quiz.js?v=67','./js/learn.js?v=67','./js/browse.js?v=67','./js/reference.js?v=67','./js/pyq.js?v=67','./js/wotd.js?v=67',
  './js/config.js?v=67','./js/lead.js?v=67',
  './manifest.webmanifest',
  './assets/banner.png?v=67',
