...
const SHELL = [
  ...
  './css/styles.css?v=69',
  './js/data.js?v=69','./js/quiz.js?v=69','./js/learn.js?v=69','./js/browse.js?v=69','./js/reference.js?v=69','./js/pyq.js?v=69','./js/wotd.js?v=69',
  './js/config.js?v=69','./js/lead.js?v=69',
  './manifest.webmanifest',
  './assets/banner.png?v=69',
