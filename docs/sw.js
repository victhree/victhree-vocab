...
const SHELL = [
  ...
  './css/styles.css?v=68',
  './js/data.js?v=68','./js/quiz.js?v=68','./js/learn.js?v=68','./js/browse.js?v=68','./js/reference.js?v=68','./js/pyq.js?v=68','./js/wotd.js?v=68',
  './js/config.js?v=68','./js/lead.js?v=68',
  './manifest.webmanifest',
  './assets/banner.png?v=68',
